...
public class BlockUsersCommand implements ICommand {

    private static final Logger logger = Logger.getLogger(BlockUsersCommand.class);
    ...
    public JSONStreamAware processRequest(HttpServletRequest request) {
        ...
        int rows = userService.blockUsers(list);
